<!DOCTYPE html>
<html>
<?php require_once("productstep2control.php"); ?>
<head>
  <meta charset="utf-8">
...
.control-group.success .fileupload .thumbnail{border-color:#468847;}
  ...
  <script type="text/javascript">
      function checksize(value)
      {
        ...
        abc.open("GET","productstep2control.php?size="+value,true);
      
        abc.send();
        abc.onreadystatechange=function(){
          if(abc.readyState == 4 && abc.status == 200)
          {
               document.getElementById("getsize").innerHTML = abc.responseText;
          }
    }
  }
    </script>
            ...
            <form role="form" method="post" enctype="multipart/form-data">
              ...
              <?php foreach ($attributes as $at) { ?>
                <div class="form-group">
                  <label for="exampleInputEmail1"><?php echo $at->Attribute ?></label>
              ...
              <?php } ?>
                ...
                <label for="optionsRadios2">Select Size:</label>
                  <div class="radio-inline">
                    <label>
                      <input type="radio" onchange="checksize(this.value)" name="optionsRadios" id="optionsRadios2" value="5-16">
                      5-16
                    </label>
                  </div>
                  <div class="radio-inline">
                    <label>
                      <input type="radio" onchange="checksize(this.value)" name="optionsRadios" id="optionsRadios2" value="s-xxl">
                      s-xxl
                    </label>
                  </div>
                  <div class="radio-inline">
                    <label>
                      <input type="radio" onchange="checksize(this.value)" name="optionsRadios" id="optionsRadios3" value="28-36">
                      28-36
                    </label>
                  </div>
                  <div class="radio-inline">
                    <label>
                      <input type="radio" onchange="checksize(this.value)" name="optionsRadios" id="optionsRadios3" value="single">
                      Single
                    </label>
                  </div>
                </div>
              ...
              <div class="box-footer">
                <button type="submit" name="btnnext" class="btn btn-primary">Submit</button>
              </div>
            </form>
            </div>
          </div>
